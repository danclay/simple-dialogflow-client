 ...
 * @param {string} options.keyPath Aabsolute path to the GCP service account JSON key
 * @param {string} [options.convertResult=true] If using a custom response payload and you want it to be given to you in JSON (if used this will be given in result.fulfillmentMessagesJSON)
 * @param {Boolean} [options.storeSessions=true] If you want session stored
 ...
 * @param {Boolean} [options.debug=false] Enable or disable debug
 */
const init = (options) => {
